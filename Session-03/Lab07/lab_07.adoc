...
+
----
e.g. JAVA_HOME=C:\Program Files\Java\jdk1.8.0_112 or equivalent on Linux/MacOS
----
...
.. Add the contents of _file:./steeltoe/config-repo_ to the github repo you just created
