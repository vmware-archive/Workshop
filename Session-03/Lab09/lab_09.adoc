...
..  Include="Steeltoe.CloudFoundry.Connector.MySql" Version="1.0.0-rc2"
...
----
  <ItemGroup>
   .......
    ...
    <PackageReference Include="Pivotal.Discovery.Client" version="1.0.0-rc2" />
    <PackageReference Include="Steeltoe.CloudFoundry.Connector.MySql" version="1.0.0-rc2" />
  </ItemGroup>
----
...
. Expand the ``Fortune-Teller-UI`` project.
. Open ``.csproj`` and add the``PackageReference``:
..  Include="Steeltoe.CloudFoundry.Connector.Redis" Version="1.0.0-rc2"
...
. Expand the ``Fortune-Teller-UI`` project.
. Open ``.csproj`` and add the``PackageReference``:
..  Include="Steeltoe.Security.DataProtection.Redis" Version="1.0.0-rc2"
...
----
  <ItemGroup>
   .......
    ...
    <PackageReference Include="Pivotal.Discovery.Client" version="1.0.0-rc2" />
    <PackageReference Include="Steeltoe.CloudFoundry.Connector.Redis" version="1.0.0-rc2" />
    <PackageReference Include="Steeltoe.Security.DataProtection.Redis" version="1.0.0-rc2" />
  </ItemGroup>
----
