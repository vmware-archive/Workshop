...
. Open the _FortuneTeller.sln_ solution as your starting point. You will then stick with this throughout the workshop, and you will be writing new code and debugging what you write.
